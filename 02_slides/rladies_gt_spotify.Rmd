...
df_albums <- get_artist_audio_features(artist = ARTISTA) %>%
  select(
...
df_albums <- readRDS(here::here('01_caso_spotify/tracks_features.rds')) %>% 
   group_by(
    album_images, artist_name, album_id, album_name, album_release_date
  ) %>%
  summarise(
...
Con **muchas** capas, se convierte el df original en la siguiente tabla:

```{r, echo=FALSE, out.width='50%', fig.align='center'}
knitr::include_graphics(here::here('01_caso_spotify/tablas/tabla_8.png'))
```
---
