...
Se configura el token para conexión a la API de Spotify. El siguiente chunk buscará las variables de entorno:
...
Estas variables se obtienen con una cuenta en la página de desarrolladores de Spotify:
...
gt::gtsave(tabla_final, 'tabla_user.png', 
...
```{r, eval=FALSE, echo=FALSE, layout='l-page'}
gt::gtsave(tabla_final, 'tabla_tracks.png', 
           vwidth = 2000, vheight = 3000)
```
...
```{r, eval=FALSE, echo=FALSE, layout='l-page'}
gt::gtsave(tabla_final, 'tabla_albums.png', 
           vwidth = 2000, vheight = 3000)
```
