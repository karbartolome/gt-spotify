...
Dejamos un script: 🔗 [generar_tabla_artista.R](https://github.com/karbartolome/gt-spotify/generar_tabla_artista.R) que permite generar la tabla del .Rmd a partir de una función para un artista específico. 

Si te interesa, 🤩**podes utilizar la función para genrear tu tabla {gt} para tu artista favorito y compartirla en las redes con los hashtags: #RLadiesBA y #RStatsES** 🤩
